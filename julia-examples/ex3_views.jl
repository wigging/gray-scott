#=
Example of the Gray-Scott model using Julia with array views. A five-point
stencil is used to calculate the Laplacian using array slices.
=#

using Plots

@views function lap5(f, h2)
